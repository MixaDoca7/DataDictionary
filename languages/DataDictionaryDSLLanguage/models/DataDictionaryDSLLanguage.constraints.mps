...
<model ref="r:f2857333-d75c-4789-b303-4e75479d8895(DataDictionaryDSLLanguage.constraints)">
  ...
  <node concept="1M2fIO" id="4Bnt$kqjxpy">
    <property role="3GE5qa" value="elementsOfTable" />
    <ref role="1M2myG" to="to3y:11iTBZQLnUb" resolve="PredefinedDomen" />
    <node concept="EnEH3" id="4Bnt$kqjxpz" role="1MhHOB">
      <ref role="EomxK" to="to3y:11iTBZQLLWU" resolve="size" />
      <node concept="QB0g5" id="4Bnt$kqjxrp" role="QCWH9">
        <node concept="3clFbS" id="4Bnt$kqjxrq" role="2VODD2">
          <node concept="3clFbF" id="4Bnt$kqjxEj" role="3cqZAp">
            <node concept="2d3UOw" id="4Bnt$kqrJH7" role="3clFbG">
              <node concept="1Wqviy" id="4Bnt$kqjxEi" role="3uHU7B" />
              <node concept="3cmrfG" id="4Bnt$kqj_59" role="3uHU7w">
